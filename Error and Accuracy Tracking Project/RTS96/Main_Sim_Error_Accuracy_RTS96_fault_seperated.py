...
branches = np.genfromtxt('RTS96_Branches_wVolt.csv',delimiter=',')
buses = np.genfromtxt('RTS96_Buses_wVolt', delimiter=',') #this is for bus fault code
...
#		result_test = Run_SIM(gen_bus,dynamic,out) #array of one row containing all voltage output CHANGED to an array of (rows = # of voltages, columns = # of time instances)
		#Choose random bus for bus fault
		#Choose random line for line outage or line fault
